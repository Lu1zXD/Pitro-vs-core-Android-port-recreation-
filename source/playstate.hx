...
//			remove(bg);
	...
	var lastRerecreationPlayheadPosition:Int = 0;
	...
	function startSong():Void
	{
		...
		lastRerecreationPlayheadPosition = 0;
...
if(ratingName == '?') {
			scoreTxt.text = 'Score: ' + songScore + ' | recreation by LuizXD| Misses: ' + songMisses + ' | Rating: ' + ratingName;
		} else {
			scoreTxt.text = 'Score: ' + songScore + ' | recreation by LuizXD| Misses: ' + songMisses + ' | Rating: ' + ratingName + ' (' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%)' + ' - ' + ratingFC;
		}
